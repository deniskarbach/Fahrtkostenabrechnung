...
Anspruch dem Grunde nach: bereinigte Abwesenheit `S−T` ≥ 8:01 h (481 Minuten).
Ohne „Tagegeld beantragen? = Ja" kein Kreuz. Die Stufe ergibt sich aus der
Rest-Zeit `S−T−Q−R`:

| Rest-Zeit | Spalte (BERECHNUNG) | Bedeutung |
|---|---|---|
| unter 8:01 h | M | anteilig ≤8h |
| 8:01 h bis unter 14 h | N | >8h |
| 14 h bis unter 24 h | O | ≥14h |
| ab 24 h | P | 24h |
